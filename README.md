...
* CHANGE: Cost of shop items and kits for lower cost
* ADD: Option to deactivate mysql
* ADD: Permissions
* ADD: Kits in config (remove, add, deactivate)
* ADD: Shop items in config
* ADD: Multiple arenas per server (Version 2.0)
